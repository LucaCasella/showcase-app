        ...
        <div className='max-w-7xl mx-auto'>
            ...
            <div className='flex flex-col lg:flex-row gap-10 my-20'>
                <div className='lg:w-2/3 flex flex-col'>
                    ...
                    <form action="" className='flex flex-col gap-20 p-5 border-1 border-y-transparent border-x-black'>
                        <input type="text"
                               className='text-center border-none border-bottom focus:outline-none focus:ring-0 placeholder:text-black placeholder:text-center placeholder:tracking-widest'
                        ...
                        <textarea name="message"
                                  id="contact-message"
                                  className='h-32 min-h-20 text-center border-none border-bottom focus:outline-none focus:ring-0 placeholder:text-black placeholder:text-center placeholder:tracking-widest'
                                  placeholder='Il tuo messaggio'
                        />
                        <button type='submit' className='w-1/2 mx-auto border border-[#DEE2E6] p-2'>INVIA MESSAGGIO
                        </button>
                    </form>
