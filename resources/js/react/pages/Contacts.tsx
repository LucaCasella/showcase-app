        ...
        <div className='max-w-7xl mx-auto'>
            ...
            <div className='flex flex-col lg:flex-row gap-10 my-20'>
                <div className='lg:w-2/3 flex flex-col'>
                    ...
                    <form onSubmit={handleSubmit} className='flex flex-col gap-16 p-5 border-1 border-y-transparent border-x-black'>
                        <div>
                            <div>
                                <input
                                    type="text"
                        ...
                        <button type='submit' className='w-full sm:w-1/2 mx-auto font-normal border-1 border-slate-700 p-2'>
