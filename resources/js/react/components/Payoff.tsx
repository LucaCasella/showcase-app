...
const Payoff = () => {
    ...
    return (
        <div className='flex flex-col gap-10 lg:gap-20 text-white left-5 lg:left-10 bottom-5 lg:bottom-10'>
            ...
            <div className='hidden md:flex gap-10 items-center'>
                <p className='text-sm lg:text-xl xl:text-2xl font-semibold'>{languageData.header.payoff.winner}Vincitrice del wedding awards 2025 - Победитель свадебной премии 2025 года - Winner of the 2025 wedding awards</p>
                <div id="wp-ratedWA">
                    <a target="_blank"
